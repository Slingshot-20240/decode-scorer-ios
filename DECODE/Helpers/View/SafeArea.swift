...
class SafeArea {
    ...
    func update(_ proxy: GeometryProxy) {
        ...
        if UIApplication.shared.orientedLeft {
            ...
            self.trailing = 8
            self.rectangularTrailing =
                proxy.safeAreaInsets.trailing > 8
                ? proxy.safeAreaInsets.trailing / 2 : 8
        } else if UIApplication.shared.orientedRight {
            self.leading = 8
            self.rectangularLeading =
                proxy.safeAreaInsets.leading > 8
                ? proxy.safeAreaInsets.leading / 2 : 8
